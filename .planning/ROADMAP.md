...
- [x] 01-03-PLAN.md — Wire client→server compile + projects block + full EDIT-01..05 drag/reorder/inline/undo verification (criterion 2)
- [x] 01-04-PLAN.md — mj-attributes experiment (Part A + Part B) + BLOCK_DEFAULTS validation (criterion 5)
